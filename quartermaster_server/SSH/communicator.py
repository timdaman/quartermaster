...
from quartermaster.AbstractCommunicator import AbstractCommunicator, CommandResponse
...
class SSH(AbstractCommunicator):
    ...
    def get_host_key(self) -> PKey:
        ...
        if key_type not in self.HOST_KEY_FORMAT_MAPPINGS:
            raise Exception(f"Unable to handle key of type {key_type}")
    ...
    def get_private_key(self):
        ...
        try:
            ...
            raise Exception(f"Private key error {repr(self.host)}", e)
        return private_key
